...
import game3Tmp from '../templates/game-3';
...
const game2Tmp = getElementFromTemplate(template);
const gameAnswers = game2Tmp.querySelectorAll(`.game__answer`);
